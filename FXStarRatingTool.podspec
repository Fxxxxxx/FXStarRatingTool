#
#  Be sure to run `pod spec lint FXStarRatingTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                "超级简单易用的星星评分工具，设置好属性，一行代码显示，block回调结果，超快速集成。"
                   DESC

  s.homepage     = "https://github.com/Fxxxxxx/FXStarRatingTool"
  ...
  s.source       = { :git => "https://github.com/Fxxxxxx/FXStarRatingTool.git", :tag => "1.0.0" }
